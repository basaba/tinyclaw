...
> Lobster-Copilot extends Lobster — it does not replace it. All Lobster pipeline syntax, expressions, workflow files, and built-in commands remain available. This part covers only the additions.
